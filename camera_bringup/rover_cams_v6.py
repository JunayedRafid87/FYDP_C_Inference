...
ALIASES = {
    ...
    "aqi": "aqi", "iaq": "aqi",
    "temp": "temp", "temperature": "temp", "t": "temp", "temp_c": "temp",
    "hum": "hum", "humidity": "hum", "rh": "hum", "hum_pct": "hum",
}
...
def parse_line(line):
    """Accept JSON objects or loose key=value / key:value text.

    Firmware output varies and often carries boot banners and debug prints,
    so anything unparseable is ignored rather than treated as an error.
    """
    line = line.strip()
    if not line:
        return {}
